...
module.exports = {
  ...
  usage: 'removexp',
  help: [
    { name: 'removexp', description: 'Remove experience from a user', aliases: 'n/a', parameters: '<member> <xp>', information: 'n/a', usage: 'removexp <member> <xp>', example: ',removexp x_____j 13' }
  ],

  run: async (client, message, args) => {

    if (!needPerm(message, 'ManageGuild', 'manage_guild')) return;
    return info(message, `removexp`, `Remove experience from a user (params: member, xp)`);
  }
};
