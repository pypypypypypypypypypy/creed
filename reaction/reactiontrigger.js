...
module.exports = {
  ...
  category: 'reaction',
  usage: 'reactiontrigger',
  help: [
    { name: 'reactiontrigger', description: 'reactiontrigger command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'reactiontrigger [args]', example: 'reactiontrigger' }
  ],

  run: async (client, message, args) => {
    return info(message, 'reactiontrigger', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
