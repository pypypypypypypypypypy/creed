...
module.exports = {
  ...
  help: [
    {
        name: 'angrystare',
        description: 'Perform the angrystare action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'angrystare [user]',
        example: 'angrystare user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('angrystare');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** stared angrily at **${target.displayName}** 😠`)
      .setImage(gif || null);
