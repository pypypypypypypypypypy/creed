...
module.exports = {
  ...
  help: [
    {
        name: 'thumbsup',
        description: 'Perform the thumbsup action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'thumbsup [user]',
        example: 'thumbsup user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('thumbsup');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** gave a thumbs up to **${target.displayName}** 👍`)
      .setImage(gif || null);
