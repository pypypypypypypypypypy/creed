...
module.exports = {
  ...
  help: [
    {
        name: 'slowclap',
        description: 'Perform the slowclap action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'slowclap [user]',
        example: 'slowclap user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('slowclap');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** slow clapped at **${target.displayName}** 👏`)
      .setImage(gif || null);
