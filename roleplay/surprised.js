...
module.exports = {
  ...
  help: [
    {
        name: 'surprised',
        description: 'Perform the surprised action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'surprised [user]',
        example: 'surprised user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('surprised');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** was surprised by **${target.displayName}** 😲`)
      .setImage(gif || null);
