...
module.exports = {
  ...
  help: [
    {
        name: 'facepalm',
        description: 'Perform the facepalm action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'facepalm [user]',
        example: 'facepalm user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('facepalm');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** facepalmed at **${target.displayName}** 🤦`)
      .setImage(gif || null);
