...
module.exports = {
  ...
  help: [
    {
        name: 'airkiss',
        description: 'Perform the airkiss action on a user',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'airkiss [user]',
        example: 'airkiss user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('airkiss');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** gave an air kiss to **${target.displayName}** 💋`)
      .setImage(gif || null);
