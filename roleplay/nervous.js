...
module.exports = {
  ...
  help: [
    {
        name: 'nervous',
        description: 'Perform the nervous action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'nervous [user]',
        example: 'nervous user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('nervous');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** is nervous around **${target.displayName}** 😰`)
      .setImage(gif || null);
