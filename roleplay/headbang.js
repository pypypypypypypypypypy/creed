...
module.exports = {
  ...
  help: [
    {
        name: 'headbang',
        description: 'Perform the headbang action',
        aliases: 'n/a',
        parameters: '[user]',
        information: 'n/a',
        usage: 'headbang [user]',
        example: 'headbang user'
    }
],
  ...
  run: async (client, message, args) => {
    ...
    const gif = await getRpGif('headbang');
    const embed = new EmbedBuilder()
      .setColor(color)
      .setDescription(`**${message.member.displayName}** headbanged with **${target.displayName}** 🤘`)
      .setImage(gif || null);
