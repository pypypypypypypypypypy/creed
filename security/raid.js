...
module.exports = {
  ...
  usage: 'raid',
  help: [
    { name: 'raid', description: 'raid command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'raid [args]', example: 'raid' }
  ],

  run: async (client, message, args) => {
    return info(message, 'raid', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
