...
module.exports = {
  ...
  usage: 'donate',
  help: [
    { name: 'donate', description: 'support upset thru various payment methods', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'donate', example: 'donate' }
  ],

  run: async (client, message, args) => {

    return info(message, `donate`, `support upset thru various payment methods`);
  }
};
