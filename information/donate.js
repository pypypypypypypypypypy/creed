...
module.exports = {
  name: 'donate', category: 'information', usage: 'donate',
  help: [{ name: 'donate', description: 'Support the bot', aliases: 'n/a', parameters: 'n/a', information: 'n/a', usage: 'donate', example: 'donate' }],
  run: async (client, message, args) => {
    const url = process.env.DONATE_URL || 'https://github.com/sponsors';
    return info(message, 'Donate', `Support development: ${url}`);
  }
};
