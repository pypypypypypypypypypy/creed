...
module.exports = {
  ...
  run: async (client, message, args) => {
    const embed = new EmbedBuilder()
      ...
      .addFields({ name: `**FAQ**`, value: `Please reach out to **four#0001** on Discord for priority replies. Additionally, you can join the [support server](https://discord.gg/stain) and send a message in the main channel which will automatically alert us.
