...
module.exports = {
  ...
  usage: 'emojis',
  help: [
    { name: 'emojis', description: 'view the emojis in the current guild', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'emojis', example: 'emojis' }
  ],

  run: async (client, message, args) => {

    return info(message, `emojis`, `view the emojis in the current guild`);
  }
};
