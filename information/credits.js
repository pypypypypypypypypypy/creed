...
module.exports = {
  ...
  usage: 'credits',
  help: [
    { name: 'credits', description: 'Get credits on the bot s contributor s team', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'credits', example: 'credits' }
  ],

  run: async (client, message, args) => {

    return info(message, `credits`, `Get credits on the bot s contributor s team`);
  }
};
