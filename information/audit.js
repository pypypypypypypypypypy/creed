...
module.exports = {
  ...
  usage: 'audit',
  help: [
    { name: 'audit', description: 'view the most recent audit logs for the guild', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'audit', example: 'audit' }
  ],

  run: async (client, message, args) => {

    return info(message, `audit`, `view the most recent audit logs for the guild`);
  }
};
