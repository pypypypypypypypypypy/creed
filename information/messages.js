...
module.exports = {
  ...
  usage: 'messages',
  help: [
    { name: 'messages', description: 'messages command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'messages [args]', example: 'messages' }
  ],

  run: async (client, message, args) => {
    return info(message, 'messages', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
