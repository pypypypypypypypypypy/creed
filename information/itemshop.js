...
module.exports = {
  ...
  usage: 'itemshop',
  help: [
    { name: 'itemshop', description: 'View the Fortnite item shop', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'itemshop', example: 'itemshop' }
  ],

  run: async (client, message, args) => {

    return info(message, `itemshop`, `View the Fortnite item shop`);
  }
};
