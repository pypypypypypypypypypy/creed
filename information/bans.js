...
module.exports = {
  ...
  usage: 'bans',
  help: [
    { name: 'bans', description: 'view the list of the bans for the guild', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'bans', example: 'bans' }
  ],

  run: async (client, message, args) => {

    if (!needPerm(message, 'BanMembers', 'ban_members')) return;
    return info(message, `bans`, `view the list of the bans for the guild`);
  }
};
