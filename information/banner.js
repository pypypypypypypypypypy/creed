...
module.exports = {
  ...
  usage: 'banner',
  help: [
    { name: 'banner', description: 'View a user s banner', aliases: 'n/a', parameters: '<user>', information: 'n/a', usage: 'banner <user>', example: ',banner @j______j' }
  ],

  run: async (client, message, args) => {

    return info(message, `banner`, `View a user s banner (params: user)`);
  }
};
