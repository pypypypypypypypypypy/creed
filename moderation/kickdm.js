...
module.exports = {
  ...
  usage: 'kickdm',
  help: [
    { name: 'kickdm', description: 'kickdm command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'kickdm [args]', example: 'kickdm' }
  ],

  run: async (client, message, args) => {
    return info(message, 'kickdm', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
