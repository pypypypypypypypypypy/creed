...
module.exports = {
  ...
  usage: 'recentban',
  help: [
    { name: 'recentban', description: 'recentban command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'recentban [args]', example: 'recentban' }
  ],

  run: async (client, message, args) => {
    return info(message, 'recentban', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
