...
module.exports = {
  ...
  usage: 'unjaildm',
  help: [
    { name: 'unjaildm', description: 'unjaildm command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'unjaildm [args]', example: 'unjaildm' }
  ],

  run: async (client, message, args) => {
    return info(message, 'unjaildm', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
