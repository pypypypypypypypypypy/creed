...
module.exports = {
  ...
  usage: 'softbandm',
  help: [
    { name: 'softbandm', description: 'softbandm command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'softbandm [args]', example: 'softbandm' }
  ],

  run: async (client, message, args) => {
    return info(message, 'softbandm', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
