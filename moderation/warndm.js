...
module.exports = {
  ...
  usage: 'warndm',
  help: [
    { name: 'warndm', description: 'warndm command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'warndm [args]', example: 'warndm' }
  ],

  run: async (client, message, args) => {
    return info(message, 'warndm', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
