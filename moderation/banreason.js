...
module.exports = {
  ...
  usage: 'banreason',
  help: [
    { name: 'banreason', description: 'Check the reason why this member was banned', aliases: 'n/a', parameters: '<member>', information: 'n/a', usage: 'banreason <member>', example: 'banreason' }
  ],

  run: async (client, message, args) => {

    if (!needPerm(message, 'BanMembers', 'ban_members')) return;
    return info(message, `banreason`, `Check the reason why this member was banned (params: member)`);
  }
};
