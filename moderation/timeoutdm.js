...
module.exports = {
  ...
  usage: 'timeoutdm',
  help: [
    { name: 'timeoutdm', description: 'timeoutdm command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'timeoutdm [args]', example: 'timeoutdm' }
  ],

  run: async (client, message, args) => {
    return info(message, 'timeoutdm', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
