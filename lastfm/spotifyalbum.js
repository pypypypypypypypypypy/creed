...
module.exports = {
  ...
  usage: 'spotifyalbum',
  help: [
    { name: 'spotifyalbum', description: 'Finds album results from the Spotify API', aliases: 'n/a', parameters: '<query>', information: 'n/a', usage: 'spotifyalbum <query>', example: ',spotify album Lucki Freewave 3' }
  ],

  run: async (client, message, args) => {

    return info(message, `spotifyalbum`, `Finds album results from the Spotify API (params: query)`);
  }
};
