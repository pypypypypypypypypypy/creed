...
module.exports = {
  ...
  usage: 'itunes',
  help: [
    { name: 'itunes', description: 'Finds a song from the iTunes API', aliases: 'n/a', parameters: '<query>', information: 'n/a', usage: 'itunes <query>', example: ',itunes ram ranch' }
  ],

  run: async (client, message, args) => {

    return info(message, `itunes`, `Finds a song from the iTunes API (params: query)`);
  }
};
