...
module.exports = {
  ...
  usage: 'spotifytrack',
  help: [
    { name: 'spotifytrack', description: 'Finds track results from the Spotify API', aliases: 'n/a', parameters: '<query>', information: 'n/a', usage: 'spotifytrack <query>', example: 'Lucki Geek Monster' }
  ],

  run: async (client, message, args) => {

    return info(message, `spotifytrack`, `Finds track results from the Spotify API (params: query)`);
  }
};
