...
module.exports = {
  ...
  usage: 'fortnite',
  help: [
    { name: 'fortnite', description: 'fortnite command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'fortnite [args]', example: 'fortnite' }
  ],

  run: async (client, message, args) => {
    return info(message, 'fortnite', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
