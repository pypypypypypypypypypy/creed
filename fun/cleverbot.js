...
module.exports = {
  ...
  usage: 'cleverbot',
  help: [
    { name: 'cleverbot', description: 'cleverbot command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'cleverbot [args]', example: 'cleverbot' }
  ],

  run: async (client, message, args) => {
    return info(message, 'cleverbot', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
