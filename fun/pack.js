...
module.exports = {
  ...
  usage: 'pack',
  help: [
    { name: 'pack', description: 'blaze that nigga yahurd', aliases: 'n/a', parameters: '<member>', information: 'n/a', usage: 'pack <member>', example: ',pack jonathan' }
  ],

  run: async (client, message, args) => {

    return info(message, `pack`, `blaze that nigga yahurd (params: member)`);
  }
};
