...
module.exports = {
  name: 'clearavatars', category: 'utility', usage: 'clearavatars',
  help: [{ name: 'clearavatars', description: 'Clear your stored avatar history', aliases: 'n/a', parameters: 'n/a', information: 'n/a', usage: 'clearavatars', example: 'clearavatars' }],
  run: async (client, message, args) => {
    db.delete(`avatarhistory_${message.author.id}`);
    return ok(message, 'Cleared your avatar history.');
  }
};
