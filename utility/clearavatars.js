...
module.exports = {
  ...
  usage: 'clearavatars',
  help: [
    { name: 'clearavatars', description: 'reset your recorded avatar changes', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'clearavatars', example: 'clearavatars' }
  ],

  run: async (client, message, args) => {

    return info(message, `clearavatars`, `reset your recorded avatar changes`);
  }
};
