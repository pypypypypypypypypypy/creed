...
module.exports = {
  ...
  usage: 'streamable',
  help: [
    { name: 'streamable', description: 'streamable command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'streamable [args]', example: 'streamable' }
  ],

  run: async (client, message, args) => {
    return info(message, 'streamable', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
