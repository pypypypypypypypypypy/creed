...
module.exports = {
  ...
  usage: 'tumblr',
  help: [
    { name: 'tumblr', description: 'tumblr command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'tumblr [args]', example: 'tumblr' }
  ],

  run: async (client, message, args) => {
    return info(message, 'tumblr', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
