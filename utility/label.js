...
module.exports = {
  ...
  usage: 'label',
  help: [
    { name: 'label', description: 'label command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'label [args]', example: 'label' }
  ],

  run: async (client, message, args) => {
    return info(message, 'label', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
