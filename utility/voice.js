...
module.exports = {
  ...
  usage: 'voice',
  help: [
    { name: 'voice', description: 'voice command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'voice [args]', example: 'voice' }
  ],

  run: async (client, message, args) => {
    return info(message, 'voice', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
