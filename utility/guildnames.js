...
module.exports = {
  ...
  usage: 'guildnames',
  help: [
    { name: 'guildnames', description: 'view recorded guild name changes', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'guildnames', example: 'guildnames' }
  ],

  run: async (client, message, args) => {

    return info(message, `guildnames`, `view recorded guild name changes`);
  }
};
