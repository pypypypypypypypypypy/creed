...
module.exports = {
  ...
  usage: 'medal',
  help: [
    { name: 'medal', description: 'medal command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'medal [args]', example: 'medal' }
  ],

  run: async (client, message, args) => {
    return info(message, 'medal', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
