...
module.exports = {
  ...
  usage: 'grailed',
  help: [
    { name: 'grailed', description: 'grailed command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'grailed [args]', example: 'grailed' }
  ],

  run: async (client, message, args) => {
    return info(message, 'grailed', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
