...
module.exports = {
  ...
  usage: 'topcommands',
  help: [
    { name: 'topcommands', description: 'view the top commands on upset', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'topcommands', example: 'topcommands' }
  ],

  run: async (client, message, args) => {

    return info(message, `topcommands`, `view the top commands on upset`);
  }
};
