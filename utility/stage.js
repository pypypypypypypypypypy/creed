...
module.exports = {
  ...
  usage: 'stage',
  help: [
    { name: 'stage', description: 'stage command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'stage [args]', example: 'stage' }
  ],

  run: async (client, message, args) => {
    return info(message, 'stage', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
