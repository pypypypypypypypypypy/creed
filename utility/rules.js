  ...
  run: async (client, message, args) => {
    ...
    const rulesEmbed = new EmbedBuilder()
      ...
      .setDescription(
        ...
        `- Stay away from unnecessary drama or controversial topics, and don't join in if you see one happening. This server is about bored, not about debates.\n` +
        `- By joining this server, you agree to follow both [Discord's Community Guidelines](https://discord.com/guidelines) and [bored's Terms of Service.](https://discord.com/terms)`
      );

    const infoEmbed = new EmbedBuilder()
      .setColor(color)
      .setDescription(
        `**bored** is a multipurpose app that provides over ${cmdCount} commands for free, with no strings attached\n\n` +
        ...
        `- **VoiceMaster** – bored has the popular voice master system, providing a simple VC solution for your server.\n` +
