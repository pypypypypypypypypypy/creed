...
module.exports = {
  ...
  usage: 'shorts',
  help: [
    { name: 'shorts', description: 'shorts command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'shorts [args]', example: 'shorts' }
  ],

  run: async (client, message, args) => {
    return info(message, 'shorts', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
