...
module.exports = {
  ...
  usage: 'news',
  help: [
    { name: 'news', description: 'news command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'news [args]', example: 'news' }
  ],

  run: async (client, message, args) => {
    return info(message, 'news', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
