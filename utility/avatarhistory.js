...
module.exports = {
  ...
  usage: 'avatarhistory',
  help: [
    { name: 'avatarhistory', description: 'get a user s avatar changes that have been recorded by the bot', aliases: 'n/a', parameters: '<member>', information: 'n/a', usage: 'avatarhistory <member>', example: ',avatarhistory @j______j' }
  ],

  run: async (client, message, args) => {

    return info(message, `avatarhistory`, `get a user s avatar changes that have been recorded by the bot (params: member)`);
  }
};
