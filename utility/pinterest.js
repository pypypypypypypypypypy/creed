...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    try {
      ...
      const e = new EmbedBuilder().setColor('#E60023').setTitle(`Pinterest: ${q}`).setURL(`https://www.pinterest.com/search/pins/?q=${encodeURIComponent(q)}`).setImage(pick).setTimestamp();
