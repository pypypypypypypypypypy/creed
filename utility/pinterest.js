...
module.exports = {
  ...
  usage: 'pinterest',
  help: [
    { name: 'pinterest', description: 'pinterest command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'pinterest [args]', example: 'pinterest' }
  ],

  run: async (client, message, args) => {
    return info(message, 'pinterest', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
