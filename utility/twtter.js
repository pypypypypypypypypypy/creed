...
module.exports = {
  ...
  usage: 'twtter',
  help: [
    { name: 'twtter', description: 'twtter command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'twtter [args]', example: 'twtter' }
  ],

  run: async (client, message, args) => {
    return info(message, 'twtter', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
