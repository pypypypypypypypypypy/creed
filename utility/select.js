...
module.exports = {
  ...
  usage: 'select',
  help: [
    { name: 'select', description: 'select command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'select [args]', example: 'select' }
  ],

  run: async (client, message, args) => {
    return info(message, 'select', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
