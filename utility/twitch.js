...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    try {
      ...
      const e = new EmbedBuilder().setColor('#FFFFFF').setTitle(title).setURL(`https://twitch.tv/${u}`).setDescription(desc.slice(0,2000)).addFields({ name: 'Status', value: live ? '🔴 Live' : '⚫ Offline', inline: true });
