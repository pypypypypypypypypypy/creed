...
module.exports = {
  ...
  usage: 'twitch',
  help: [
    { name: 'twitch', description: 'lookup a channel or setup notifications for twitch livestreams', aliases: 'n/a', parameters: '<username>', information: 'n/a', usage: 'twitch <username>', example: ',twitch pokimane' }
  ],

  run: async (client, message, args) => {

    return info(message, `twitch`, `lookup a channel or setup notifications for twitch livestreams (params: username)`);
  }
};
