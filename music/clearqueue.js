...
module.exports = {
  ...
  usage: 'clearqueue',
  help: [
    { name: 'clearqueue', description: 'Clear the queue', aliases: 'n/a', parameters: '', information: 'n/a', usage: 'clearqueue', example: 'clearqueue' }
  ],

  run: async (client, message, args) => {

    return info(message, `clearqueue`, `Clear the queue`);
  }
};
