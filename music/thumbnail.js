...
module.exports = {
  ...
  usage: 'thumbnail',
  help: [
    { name: 'thumbnail', description: 'thumbnail command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'thumbnail [args]', example: 'thumbnail' }
  ],

  run: async (client, message, args) => {
    return info(message, 'thumbnail', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
