...
module.exports = {
  ...
  usage: 'rewind',
  help: [
    { name: 'rewind', description: 'rewind to a specific position', aliases: 'n/a', parameters: '<position>', information: 'n/a', usage: 'rewind <position>', example: ',rewind 30s' }
  ],

  run: async (client, message, args) => {

    return info(message, `rewind`, `rewind to a specific position (params: position)`);
  }
};
