...
module.exports = {
  ...
  usage: 'imgonly',
  help: [
    { name: 'imgonly', description: 'imgonly command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'imgonly [args]', example: 'imgonly' }
  ],

  run: async (client, message, args) => {
    return info(message, 'imgonly', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
