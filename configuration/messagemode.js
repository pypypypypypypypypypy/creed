...
module.exports = {
  ...
  usage: 'messagemode',
  help: [
    { name: 'messagemode', description: 'messagemode command (ported from bleed.bot)', aliases: 'n/a', parameters: '[args]', information: 'n/a', usage: 'messagemode [args]', example: 'messagemode' }
  ],

  run: async (client, message, args) => {
    return info(message, 'messagemode', 'This command was registered as a stub from bleed.bot. Configure or extend its behavior as needed.');
  }
};
